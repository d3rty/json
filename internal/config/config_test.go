...
func TestGlobalConfig_Valid(t *testing.T) {
	...
	assert.True(t, boolConfig.FromStrings.FalseForEmptyString)
	...
	assert.Equal(t, []string{"15:04:05"}, dateConfig.FromStrings.Layouts.Time)
	assert.Equal(t, []string{"2006-01-02"}, dateConfig.FromStrings.Layouts.Date)
	assert.Equal(t, []string{
		"2006-01-02T15:04:05", "15:04:05", "2006-01-02T15:04:05Z07:00", "2006-01-02T15:04:05.999999999Z07:00",
	}, dateConfig.FromStrings.Layouts.DateTime)
	assert.Equal(t, []string{
		"today", "yesterday", "tomorrow", "this-{week|month|year}", "last-{week|month|year}",
	}, dateConfig.FromStrings.Aliases)
